  ...
  useEffect(() => {
    ...
    components.forEach((comp) => {
      ...
      if (comp.type.includes("IC")) {
        ...
        comp.type.includes("Resistor") ||
        comp.type.includes("Capacitor")
      ) {
          ...
          <div className="flex flex-col bg-[#101422ee] backdrop-blur-md border border-[#ffffff1a] rounded-[10px] p-2 shadow-xl min-w-[120px]">
            {contextDescription && (
              <div className="mb-1 pb-1 border-b border-[#ffffff1a]">
                <span className="text-[10px] font-bold text-[#3EE28B] uppercase tracking-wider block">
                  AI Context
                </span>
                <p className="text-[11px] text-[#EAF0FF] leading-tight">
                  {contextDescription}
                </p>
              </div>
            )}
            ...
            <div className="flex items-center justify-between gap-2">
              <span className="text-[11px] font-bold text-[#BBBBBB]">
                {hoveredComponent.name}
              </span>
              <span className="text-[9px] text-[#555555] bg-[#ffffff0a] px-1 rounded">
